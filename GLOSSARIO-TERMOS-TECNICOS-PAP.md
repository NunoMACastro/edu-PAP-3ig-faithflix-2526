# Glossario de Termos Tecnicos - PAP (Projeto FaithFlix)

Objetivo: explicar termos tecnicos da documentacao e da planificacao sem linguagem complicada.

## 0) Termos especificos do FaithFlix

### Curadoria teologica

- O que e: selecao editorial de conteudo com criterio biblico e pastoral.
- No projeto: garante coerencia do catalogo com a proposta do FaithFlix.

### Pool solidaria de associacoes

- O que e: mecanismo de distribuicao periodica para associacoes aprovadas.
- No projeto: liga subscricoes a impacto social mensuravel.

### Continuar a ver

- O que e: funcionalidade que retoma reproducao no ponto anterior.
- No projeto: melhora retencao e experiencia de consumo recorrente.

### Watchlist e favoritos

- O que e: listas pessoais para guardar conteudos a ver mais tarde.
- No projeto: alimenta descoberta e recomendacao personalizada.

### Perfis familiares e controlo parental

- O que e: separacao de perfis com regras de acesso por faixa etaria.
- No projeto: protege menores e organiza utilizacao por agregado familiar.

### Estudo biblico integrado

- O que e: associacao de guias, passagens e reflexoes ao conteudo audiovisual.
- No projeto: diferencia a plataforma para uso formativo e devocional.
...
- Exemplo: "o utilizador pode adicionar conteudo a watchlist".
...
- Exemplo: utilizadores finais, moderadores, associacoes parceiras e administradores.
...
- O que e: padrao de autenticacao muito usado em plataformas/organizacoes.
...
- O que e: limites de uso de IA por utilizador, perfil ou plano.
...
Documento contextualizado para o dominio do FaithFlix (streaming cristao).
