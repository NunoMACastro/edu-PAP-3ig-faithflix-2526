...
export function SearchFilters({ filters, onChange, onSubmit }) {
    ...
    /**
     * Propaga a alteração de um filtro para o componente pai.
     *
     * A função cria um novo objeto de filtros para preservar imutabilidade e
     * deixar o pai decidir quando executar a pesquisa.
     *
     * @param {string} field Nome do filtro alterado.
     * @param {string} value Valor escolhido no input ou select.
     * @returns {void} Não devolve valor; chama `onChange`.
     */
