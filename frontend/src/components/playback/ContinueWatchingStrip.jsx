...
/**
 * Calcula a percentagem já vista de um item.
 *
 * A duração zero ou ausente devolve `0` para evitar divisões inválidas na barra
 * de progresso.
 *
 * @param {{ currentTimeSeconds?: number, durationSeconds?: number }} item Item de progresso.
 * @returns {number} Percentagem arredondada de visualização concluída.
 */
