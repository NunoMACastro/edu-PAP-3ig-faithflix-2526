...
/**
 * Botão genérico usado pelas páginas MF1 e formulários futuros.
 *
 * @param {{ children: React.ReactNode, type?: "button" | "submit" | "reset", variant?: string, disabled?: boolean, onClick?: React.MouseEventGestor<HTMLButtonElement> }} props - Propriedades do botão.
 ...
 * @param {React.MouseEventGestor<HTMLButtonElement>} [props.onClick] - Gestor opcional de clique.
