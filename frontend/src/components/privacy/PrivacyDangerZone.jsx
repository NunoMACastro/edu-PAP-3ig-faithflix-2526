/**
 * @file Zona de perigo para eliminacao da propria conta.
 */
...
/**
 * Renderiza o fluxo destrutivo de eliminacao de conta.
 *
...
export function PrivacyDangerZone() {
    ...
    /**
     * Envia o pedido de eliminacao ao backend.
     *
    ...
    async function handleSubmit(event) {
        ...
        try {
            ...
            setStatus("Conta eliminada. A sessao foi terminada.");
        } catch (requestError) {
    ...
    return (
        <section className="form-panel danger-panel">
            ...
            <p>Esta operacao anonimiza a conta e remove dados pessoais diretos.</p>
