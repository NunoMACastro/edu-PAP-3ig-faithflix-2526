/**
 * @file Painel de exportacao de dados do utilizador.
 */
...
/**
 * Renderiza o fluxo de exportacao RGPD.
 *
...
export function PrivacyExportPanel() {
    ...
    /**
     * Pede a exportacao ao backend e descarrega o JSON localmente.
     *
    ...
    async function handleExport() {
        ...
        try {
            ...
            setStatus("Exportacao preparada.");
        } catch (requestError) {
