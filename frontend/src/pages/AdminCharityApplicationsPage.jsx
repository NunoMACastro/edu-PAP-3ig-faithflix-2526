/**
 * @file Ficheiro `real_dev/frontend/src/pages/AdminCharityApplicationsPage.jsx` da implementação real_dev.
 */
...
export function AdminCharityApplicationsPage() {
  ...
  if (loading) return <section className="page-section"><p>A carregar candidaturas...</p></section>;
