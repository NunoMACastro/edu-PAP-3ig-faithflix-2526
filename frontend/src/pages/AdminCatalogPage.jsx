...
export function AdminCatalogPage() {
    ...
    /**
     * Documenta `loadItems`, mantendo explícita a responsabilidade desta função no módulo.
     * @returns {Promise<unknown>} Resultado devolvido por `loadItems`.
     */
    ...
    /**
     * Documenta `handleSubmit`, mantendo explícita a responsabilidade desta função no módulo.
     *
     * @param {unknown} event Valor recebido por `handleSubmit`.
     * @returns {Promise<unknown>} Resultado devolvido por `handleSubmit`.
     */
    ...
    /**
     * Documenta `changeStatus`, mantendo explícita a responsabilidade desta função no módulo.
     *
     * @param {unknown} contentId Valor recebido por `changeStatus`.
     * @param {unknown} nextStatus Valor recebido por `changeStatus`.
     * @returns {Promise<unknown>} Resultado devolvido por `changeStatus`.
     */
    ...
    /**
     * Documenta `loadRevisions`, mantendo explícita a responsabilidade desta função no módulo.
     *
     * @param {unknown} contentId Valor recebido por `loadRevisions`.
     * @returns {Promise<unknown>} Resultado devolvido por `loadRevisions`.
     */
     ...
     * @returns {Promise<unknown>} Resultado devolvido por `revertRevision`.
     */
