...
export function ForYouPage() {
    ...
    return (
        <section className="page-section">
            ...
            {!loading && !error && (recommendations?.groups ?? []).length === 0 ? (
                <EmptyState
                    title="Sem recomendacoes disponiveis"
                    description="Quando existirem sinais suficientes ou conteudos elegiveis, as sugestoes aparecem aqui."
                />
            ) : null}
