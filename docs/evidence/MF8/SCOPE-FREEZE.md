...
| IA generativa, RAG, provider externo de embeddings, vector database ou recomendacao opaca | O contrato atual permite recomendacao baseline explicavel com embeddings opcionais de conteudo. | Mantem previsibilidade e baixo risco pedagogico. | Apresentar recomendacao como regras simples, explicaveis e sem partilha de historico pessoal bruto. |
