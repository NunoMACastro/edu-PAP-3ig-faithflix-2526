# BK-MF8-04 - Ensaio tecnico da defesa
...
Neste BK a equipa vai ensaiar tempos, perguntas, negativos e limitacoes dentro da nova MF8, que concentra consolidacao, evidencia, defesa, buffer e fecho.
Origem semantica: antigo BK-MF7-04. O resultado observavel e docs/evidence/MF8/ENSAIO-TECNICO-DEFESA.md.
...
- Estado antes: a dependencia `BK-MF8-03` deve estar concluida ou explicitamente validada.
- Estado antes: a equipa ainda nao tem a evidence deste BK fechada.
- Estado depois: existe evidence objetiva em `docs/evidence/MF8/ENSAIO-TECNICO-DEFESA.md`.
- Estado depois: o handoff para `BK-MF8-05` fica claro.
...
| Evidence | docs/evidence/MF8/ENSAIO-TECNICO-DEFESA.md | Prova objetiva do BK. |
| Handoff | BK-MF8-05 | Entrada para o BK seguinte. |
