# BK-MF8-05 - Retro final e lições aprendidas
...
- estado: TODO
- esforço: S
- dependências: BK-MF8-04
- rf_rnf: transversal
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Retro final e lições aprendidas, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Entregar o objetivo central: Retro final e lições aprendidas.
...
- As dependências BK-MF8-04 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF8-05, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF8-04 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF8-05.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Retro final e lições aprendidas em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Retro final e lições aprendidas pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para BK seguinte em aberto.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Retro final e lições aprendidas.
...
- proof: BK BK-MF8-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
