...
Neste BK a equipa vai congelar escopo e excecoes permitidas dentro da nova MF8, que concentra consolidacao, evidencia, defesa, buffer e fecho.
Origem semantica: antigo BK-MF8-03. O resultado observavel e docs/evidence/MF8/SCOPE-FREEZE-FINAL.md.
...
- Estado antes: a dependencia `BK-MF8-07` deve estar concluida ou explicitamente validada.
- Estado antes: a equipa ainda nao tem a evidence deste BK fechada.
- Estado depois: existe evidence objetiva em `docs/evidence/MF8/SCOPE-FREEZE-FINAL.md`.
- Estado depois: o handoff para `BK-MF8-09` fica claro.
...
| Evidence | docs/evidence/MF8/SCOPE-FREEZE-FINAL.md | Prova objetiva do BK. |
| Handoff | BK-MF8-09 | Entrada para o BK seguinte. |
