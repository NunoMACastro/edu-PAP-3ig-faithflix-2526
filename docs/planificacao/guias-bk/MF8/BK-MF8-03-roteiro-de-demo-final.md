...
Neste BK a equipa vai transformar evidence em narrativa de demo dentro da nova MF8, que concentra consolidacao, evidencia, defesa, buffer e fecho.
Origem semantica: antigo BK-MF7-03. O resultado observavel e docs/evidence/MF8/ROTEIRO-DEMO-FINAL.md.
...
- Estado antes: a dependencia `BK-MF8-02` deve estar concluida ou explicitamente validada.
- Estado antes: a equipa ainda nao tem a evidence deste BK fechada.
- Estado depois: existe evidence objetiva em `docs/evidence/MF8/ROTEIRO-DEMO-FINAL.md`.
- Estado depois: o handoff para `BK-MF8-04` fica claro.
...
| Evidence | docs/evidence/MF8/ROTEIRO-DEMO-FINAL.md | Prova objetiva do BK. |
| Handoff | BK-MF8-04 | Entrada para o BK seguinte. |
