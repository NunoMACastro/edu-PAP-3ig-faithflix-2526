# BK-MF8-01 - Matriz de cobertura RF -> evidencia
...
Neste BK a equipa vai ligar RF ativos a evidence objetiva dentro da nova MF8, que concentra consolidacao, evidencia, defesa, buffer e fecho.
Origem semantica: antigo BK-MF7-01. O resultado observavel e docs/evidence/MF8/MATRIZ-RF-EVIDENCIA.md.
...
- Estado antes: a dependencia `BK-MF7-05` deve estar concluida ou explicitamente validada.
- Estado antes: a equipa ainda nao tem a evidence deste BK fechada.
- Estado depois: existe evidence objetiva em `docs/evidence/MF8/MATRIZ-RF-EVIDENCIA.md`.
- Estado depois: o handoff para `BK-MF8-02` fica claro.
...
| Evidence | docs/evidence/MF8/MATRIZ-RF-EVIDENCIA.md | Prova objetiva do BK. |
| Handoff | BK-MF8-02 | Entrada para o BK seguinte. |
...
- proof: docs/evidence/MF8/MATRIZ-RF-EVIDENCIA.md.
