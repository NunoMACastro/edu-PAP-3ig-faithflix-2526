# BK-MF0-05 - Definir calendário de sprints
...
Neste BK vamos fechar a cadência de sprints, capacidade semanal e regras de replaneamento.
...
- Entregar o objetivo central: Definir calendário de sprints.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF0-05, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe um baseline claro para iniciar BK-MF0-05.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Definir calendário de sprints em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Definir calendário de sprints pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF0-06.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Definir calendário de sprints.
...
- proof: BK BK-MF0-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
