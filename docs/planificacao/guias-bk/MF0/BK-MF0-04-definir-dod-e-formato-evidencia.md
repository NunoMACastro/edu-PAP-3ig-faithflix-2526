# BK-MF0-04 - Definir DoD e formato de evidência
...
Neste BK vamos estabelecer a definição de pronto (DoD) e o formato mínimo de evidências para cada BK.
...
- Entregar o objetivo central: Definir DoD e formato de evidência.
...
- As dependências BK-MF0-03 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o "porquê" da solução e não apenas o "como".

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF0-04, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF0-03 está concluído ou suficientemente estável para permitir progresso real.
   - O que verificar: existe um baseline claro para iniciar BK-MF0-04.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Definir DoD e formato de evidência em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Definir DoD e formato de evidência pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF0-05.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Definir DoD e formato de evidência.
...
- proof: BK BK-MF0-04 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
