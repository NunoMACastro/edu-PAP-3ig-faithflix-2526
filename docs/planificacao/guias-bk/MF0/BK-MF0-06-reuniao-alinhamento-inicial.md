# BK-MF0-06 - Reunião de alinhamento inicial
...
- estado: TODO
- esforço: S
- dependências: BK-MF0-02,BK-MF0-05
- rf_rnf: transversal
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos executar o alinhamento inicial da equipa para iniciar a implementação com regras e prioridades partilhadas.
...
- A execução deste BK liga diretamente os requisitos transversal ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Reunião de alinhamento inicial.
- Produzir artefacto verificável alinhado com transversal e com o estado do backlog.
...
- As dependências BK-MF0-02,BK-MF0-05 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o "porquê" da solução e não apenas o "como".

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF0-06, owner, esforço e dependências.
- docs/planificacao/PLANO-IMPLEMENTACAO-TOTAL.md - rever secção da macro MF0.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF0-02,BK-MF0-05 está concluído ou suficientemente estável para permitir progresso real.
   - O que verificar: existe um baseline claro para iniciar BK-MF0-06.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Reunião de alinhamento inicial em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com transversal e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Reunião de alinhamento inicial pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF1-01.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Reunião de alinhamento inicial.
...
- proof: BK BK-MF0-06 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
