# BK-MF0-03 - Publicar backlog atómico inicial
...
Neste BK vamos consolidar o backlog oficial em BKs atómicos com prioridade, dependências e critério de entrada claro.
...
- Entregar o objetivo central: Publicar backlog atómico inicial.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF0-03, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe um baseline claro para iniciar BK-MF0-03.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Publicar backlog atómico inicial em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Publicar backlog atómico inicial pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF0-04.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Publicar backlog atómico inicial.
...
- proof: BK BK-MF0-03 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
