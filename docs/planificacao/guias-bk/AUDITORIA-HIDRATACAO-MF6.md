...
- `BK-MF5-06` ainda referencia caminhos `apps/...` em alguns blocos, enquanto a execução atual usa `IMPLEMENTATION_ROOT=real_dev` e os BKs MF6 apontam para `real_dev/...`. Como `BK-MF5-06` está fora do alvo, o drift fica registado e não corrigido.
