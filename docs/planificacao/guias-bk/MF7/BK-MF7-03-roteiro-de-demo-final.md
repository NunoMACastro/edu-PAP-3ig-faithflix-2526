...
- estado: TODO
- esforço: S
- dependências: BK-MF7-01
- rf_rnf: transversal
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Roteiro de demo final, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Entregar o objetivo central: Roteiro de demo final.
...
- As dependências BK-MF7-01 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF7-03, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF7-01 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF7-03.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Roteiro de demo final em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Roteiro de demo final pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF7-04.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Roteiro de demo final.
...
- proof: BK BK-MF7-03 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
