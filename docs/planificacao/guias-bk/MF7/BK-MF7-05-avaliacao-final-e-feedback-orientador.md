...
- estado: TODO
- esforço: S
- dependências: BK-MF7-02,BK-MF7-04
- rf_rnf: transversal
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Avaliação final e feedback orientador, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Entregar o objetivo central: Avaliação final e feedback orientador.
...
- As dependências BK-MF7-02,BK-MF7-04 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF7-05, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF7-02,BK-MF7-04 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF7-05.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Avaliação final e feedback orientador em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Avaliação final e feedback orientador pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF8-01.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Avaliação final e feedback orientador.
...
- proof: BK BK-MF7-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
