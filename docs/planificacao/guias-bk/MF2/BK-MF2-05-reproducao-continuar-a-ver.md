# BK-MF2-05 - Reprodução e continuar a ver
...
Neste BK vamos habilitar reprodução principal e persistência do ponto de continuidade de visualização.
...
- A execução deste BK liga diretamente os requisitos RF11,RF12 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Reprodução e continuar a ver.
- Produzir artefacto verificável alinhado com RF11,RF12 e com o estado do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF2-05, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF11,RF12.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF2-04 está concluído ou suficientemente estável para permitir progresso real.
   - O que verificar: existe um baseline claro para iniciar BK-MF2-05.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Reprodução e continuar a ver em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF11,RF12 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Reprodução e continuar a ver pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF2-06.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Reprodução e continuar a ver.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF11,RF12.
...
- proof: BK BK-MF2-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
