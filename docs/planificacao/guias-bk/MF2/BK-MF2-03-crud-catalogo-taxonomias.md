# BK-MF2-03 - CRUD de catálogo e taxonomias
...
Neste BK vamos construir operações de criação, edição e publicação de catálogo com taxonomias e histórico base.
...
- A execução deste BK liga diretamente os requisitos RF06,RF07,RF09,RF10 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: CRUD de catálogo e taxonomias.
- Produzir artefacto verificável alinhado com RF06,RF07,RF09,RF10 e com o estado do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF2-03, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF06,RF07,RF09,RF10.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe um baseline claro para iniciar BK-MF2-03.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor CRUD de catálogo e taxonomias em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF06,RF07,RF09,RF10 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo CRUD de catálogo e taxonomias pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF2-04.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a CRUD de catálogo e taxonomias.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF06,RF07,RF09,RF10.
...
- proof: BK BK-MF2-03 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
