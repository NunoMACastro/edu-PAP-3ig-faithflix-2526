...
- estado: TODO
- esforço: M
- dependências: BK-MF4-05
- rf_rnf: RF46,RF47,RF48
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Relatórios e histórico por associação, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Este BK fecha uma peça concreta da macro MF4 e reduz risco de bloqueios nos BKs seguintes.
- Uma execução guiada melhora consistência entre equipa, reduz retrabalho e acelera revisão técnica.
- A entrega deste BK contribui diretamente para os requisitos RF46,RF47,RF48 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Relatórios e histórico por associação.
- Produzir artefacto verificável alinhado com RF46,RF47,RF48 e com o estado atual do backlog.
...
- As dependências BK-MF4-05 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF4-06, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF46,RF47,RF48.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF4-05 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF4-06.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Relatórios e histórico por associação em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF46,RF47,RF48 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Relatórios e histórico por associação pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF4-07.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Relatórios e histórico por associação.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF46,RF47,RF48.
...
- proof: BK BK-MF4-06 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
