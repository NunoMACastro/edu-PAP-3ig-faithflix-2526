...
Neste BK vamos integrar métodos de pagamento simulados e regra de trial única por utilizador.
...
- A execução deste BK liga diretamente os requisitos RF37,RF40 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Métodos de pagamento simulados e trial.
- Produzir artefacto verificável alinhado com RF37,RF40 e com o estado do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF4-02, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF37,RF40.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF4-01 está concluído ou suficientemente estável para permitir progresso real.
   - O que verificar: existe um baseline claro para iniciar BK-MF4-02.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Métodos de pagamento simulados e trial em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF37,RF40 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Métodos de pagamento simulados e trial pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF4-03.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Métodos de pagamento simulados e trial.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF37,RF40.
...
- proof: BK BK-MF4-02 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
