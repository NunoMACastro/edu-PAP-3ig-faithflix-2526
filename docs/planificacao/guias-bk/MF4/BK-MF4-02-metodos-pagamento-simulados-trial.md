...
Entregar `Metodos de pagamento simulados e trial` cobrindo `RF37, RF40` na `MF4`, com fluxo principal verificavel e evidencia tecnica pronta para gate.

## Porque isto e importante

- Fecha capacidade critica desta macro sem criar drift de backlog.
- Reduz risco tecnico para o proximo BK da sequencia (`BK-MF4-03`).
...
- Entrega funcional de `Metodos de pagamento simulados e trial` com caminho principal completo.
...
- Fluxo principal de `BK-MF4-02` reproduzivel por outro colega.
...
3. Implementar o fluxo principal de `Metodos de pagamento simulados e trial`.
4. Executar smoke e validar integracao com BKs adjacentes.
5. Executar negativos obrigatorios para `P0`.
6. Atualizar evidence e preparar handoff para `BK-MF4-03`.

## Outputs esperados

- Output funcional de `BK-MF4-02` concluido sem blocker.
...
resultado = executar_fluxo_principal("Metodos de pagamento simulados e trial")
...
- Condicao: fluxo principal de `BK-MF4-02` concluido ponta-a-ponta.
