# BK-MF4-07 - Workflow editorial e denúncias
...
Neste BK vamos entregar Workflow editorial e denúncias, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- A entrega deste BK contribui diretamente para os requisitos RF49,RF50,RF51 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Workflow editorial e denúncias.
- Produzir artefacto verificável alinhado com RF49,RF50,RF51 e com o estado atual do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF4-07, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF49,RF50,RF51.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe baseline claro para iniciar BK-MF4-07.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Workflow editorial e denúncias em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF49,RF50,RF51 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Workflow editorial e denúncias pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF4-08.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Workflow editorial e denúncias.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF49,RF50,RF51.
...
- proof: BK BK-MF4-07 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
