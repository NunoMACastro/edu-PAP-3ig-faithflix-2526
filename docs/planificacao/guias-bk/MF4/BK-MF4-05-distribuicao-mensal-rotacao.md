...
- estado: TODO
- esforço: L
- dependências: BK-MF4-04
- rf_rnf: RF44,RF45
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar lógica de distribuição mensal e rotação automática das associações da pool.
...
- A execução deste BK liga diretamente os requisitos RF44,RF45 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Distribuição mensal e rotação.
- Produzir artefacto verificável alinhado com RF44,RF45 e com o estado do backlog.
...
- As dependências BK-MF4-04 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o "porquê" da solução e não apenas o "como".

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF4-05, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF44,RF45.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF4-04 está concluído ou suficientemente estável para permitir progresso real.
   - O que verificar: existe um baseline claro para iniciar BK-MF4-05.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Distribuição mensal e rotação em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF44,RF45 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Distribuição mensal e rotação pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF4-06.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Distribuição mensal e rotação.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF44,RF45.
...
- proof: BK BK-MF4-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
