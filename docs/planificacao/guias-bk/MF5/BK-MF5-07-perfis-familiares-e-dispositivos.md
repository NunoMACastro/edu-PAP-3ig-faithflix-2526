# BK-MF5-07 - Perfis familiares e dispositivos
...
- estado: TODO
- esforço: L
- dependências: BK-MF2-02,BK-MF2-05
- rf_rnf: RF61,RF62
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Perfis familiares e dispositivos, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Este BK fecha uma peça concreta da macro MF5 e reduz risco de bloqueios nos BKs seguintes.
- Uma execução guiada melhora consistência entre equipa, reduz retrabalho e acelera revisão técnica.
- A entrega deste BK contribui diretamente para os requisitos RF61,RF62 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Perfis familiares e dispositivos.
- Produzir artefacto verificável alinhado com RF61,RF62 e com o estado atual do backlog.
...
- As dependências BK-MF2-02,BK-MF2-05 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF5-07, owner, esforço e dependências.
- docs/planificacao/PLANO-IMPLEMENTACAO-TOTAL.md - rever secção da macro MF5.
- docs/planificacao/backlogs/MF-VIEWS.md - confirmar sequência recomendada na macro.
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF61,RF62.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF2-02,BK-MF2-05 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF5-07.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Perfis familiares e dispositivos em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF61,RF62 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Perfis familiares e dispositivos pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF5-08.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Perfis familiares e dispositivos.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF61,RF62.
...
- proof: BK BK-MF5-07 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
