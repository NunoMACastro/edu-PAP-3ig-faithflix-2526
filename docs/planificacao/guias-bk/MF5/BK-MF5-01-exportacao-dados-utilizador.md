...
Neste BK vamos permitir ao utilizador exportar os seus dados de forma clara, completa e auditável.
...
- A execução deste BK liga diretamente os requisitos RF55 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Exportação de dados do utilizador.
- Produzir artefacto verificável alinhado com RF55 e com o estado do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF5-01, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF55.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe um baseline claro para iniciar BK-MF5-01.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Exportação de dados do utilizador em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF55 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Exportação de dados do utilizador pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF5-02.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Exportação de dados do utilizador.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF55.
...
- proof: BK BK-MF5-01 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
