...
Neste BK vamos entregar Gestão de utilizadores admin, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- A entrega deste BK contribui diretamente para os requisitos RF58 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Gestão de utilizadores admin.
- Produzir artefacto verificável alinhado com RF58 e com o estado atual do backlog.
...
- As dependências BK-MF2-02 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF5-04, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF58.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF2-02 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF5-04.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Gestão de utilizadores admin em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF58 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Gestão de utilizadores admin pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF5-05.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Gestão de utilizadores admin.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF58.
...
- proof: BK BK-MF5-04 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
