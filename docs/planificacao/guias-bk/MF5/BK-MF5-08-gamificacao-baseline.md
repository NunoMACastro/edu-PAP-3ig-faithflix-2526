...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-08-gamificacao-baseline.md`
...
- Consolidar a entrega de `Gamificacao baseline` com rastreabilidade explicita para `RF63`.
- Executar o BK `BK-MF5-08` no contexto da macro `MF5` e da sprint `S10`.
