...
Entregar `Configuracao de integracoes admin` cobrindo `RF60` na `MF5`, com fluxo principal verificavel e evidencia tecnica pronta para gate.
...
- Entrega funcional de `Configuracao de integracoes admin` com caminho principal completo.
...
- Fluxo principal de `BK-MF5-06` reproduzivel por outro colega.
...
- Output funcional de `BK-MF5-06` concluido sem blocker.
...
resultado = executar_fluxo_principal("Configuracao de integracoes admin")
...
- Condicao: fluxo principal de `BK-MF5-06` concluido ponta-a-ponta.
