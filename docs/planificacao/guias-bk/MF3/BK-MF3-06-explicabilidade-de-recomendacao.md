# BK-MF3-06 - Explicabilidade de recomendação
...
- estado: TODO
- esforço: S
- dependências: BK-MF3-05
- rf_rnf: RF28,RNF34
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Explicabilidade de recomendação, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- A entrega deste BK contribui diretamente para os requisitos RF28,RNF34 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Explicabilidade de recomendação.
- Produzir artefacto verificável alinhado com RF28,RNF34 e com o estado atual do backlog.
...
- As dependências BK-MF3-05 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF3-06, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF28,RNF34.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF3-05 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF3-06.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Explicabilidade de recomendação em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF28,RNF34 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Explicabilidade de recomendação pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF3-07.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Explicabilidade de recomendação.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF28,RNF34.
...
- proof: BK BK-MF3-06 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
