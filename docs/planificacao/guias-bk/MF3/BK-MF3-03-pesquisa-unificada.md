...
Neste BK vamos implementar pesquisa única para catálogo e metadados com retorno consistente ao utilizador.
...
- A execução deste BK liga diretamente os requisitos RF22 ao plano operacional do backlog.
- Sem este BK bem fechado, a validação de sprint fica frágil e a evidência para defesa perde qualidade.

## O que entra (scope)

- Entregar o objetivo central: Pesquisa unificada.
- Produzir artefacto verificável alinhado com RF22 e com o estado do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF3-03, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RF22.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe um baseline claro para iniciar BK-MF3-03.
...
2. **Objetivo (~15 min): traduzir requisito para tarefas pequenas**
   ...
   - Como fazer: decompor Pesquisa unificada em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RF22 e sem invadir BKs seguintes.
...
- **Smoke**
  - O objetivo Pesquisa unificada pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF3-04.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Pesquisa unificada.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RF22.
...
- proof: BK BK-MF3-03 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
