...
Neste BK vamos entregar Acessibilidade e UX final, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- A entrega deste BK contribui diretamente para os requisitos RNF01..RNF06 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Acessibilidade e UX final.
- Produzir artefacto verificável alinhado com RNF01..RNF06 e com o estado atual do backlog.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF6-05, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RNF01..RNF06.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe baseline claro para iniciar BK-MF6-05.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Acessibilidade e UX final em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RNF01..RNF06 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Acessibilidade e UX final pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF6-06.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Acessibilidade e UX final.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RNF01..RNF06.
...
- proof: BK BK-MF6-05 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
