...
- Reduz risco tecnico para o proximo BK da sequencia (`BK-MF6-06`).
...
- Entrega funcional de `Acessibilidade e UX final` com caminho principal completo.
...
- Fluxo principal de `BK-MF6-05` reproduzivel por outro colega.
...
3. Implementar o fluxo principal de `Acessibilidade e UX final`.
4. Executar smoke e validar integracao com BKs adjacentes.
5. Executar negativos obrigatorios para `P1`.
6. Atualizar evidence e preparar handoff para `BK-MF6-06`.

## Outputs esperados

- Output funcional de `BK-MF6-05` concluido sem blocker.
...
```text
# pseudo-checklist BK-MF6-05
precondicoes_ok = validar_dependencias(["BK-MF6-02"])
assert precondicoes_ok == true

resultado = executar_fluxo_principal("Acessibilidade e UX final")
...
- Condicao: fluxo principal de `BK-MF6-05` concluido ponta-a-ponta.
