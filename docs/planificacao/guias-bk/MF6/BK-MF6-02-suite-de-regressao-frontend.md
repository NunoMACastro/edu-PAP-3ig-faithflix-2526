...
- estado: TODO
- esforço: M
- dependências: BK-MF5-08
- rf_rnf: RNF29
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Suite de regressão frontend, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Entregar o objetivo central: Suite de regressão frontend.
...
- As dependências BK-MF5-08 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF6-02, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF5-08 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF6-02.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Suite de regressão frontend em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Suite de regressão frontend pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF6-03.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Suite de regressão frontend.
...
- proof: BK BK-MF6-02 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
