...
- estado: TODO
- esforço: M
- dependências: BK-MF6-02
- rf_rnf: RNF07..RNF12
- last_updated: 2026-04-12

## O que vamos fazer neste BK

Neste BK vamos entregar Otimizacao de performance critica, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- A entrega deste BK contribui diretamente para os requisitos RNF07..RNF12 definidos no backlog.
- Sem este BK bem fechado, a qualidade das evidências para sprint e defesa final fica comprometida.

## O que entra (scope)

- Entregar o objetivo central: Otimizacao de performance critica.
- Produzir artefacto verificável alinhado com RNF07..RNF12 e com o estado atual do backlog.
...
- As dependências BK-MF6-02 foram respeitadas sem regressão funcional óbvia.
- A equipa consegue explicar o porquê da solução e não apenas o como.

## Pre-leitura mínima (10-15 min)

- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF6-04, owner, esforço e dependências.
...
- docs/RF.md e/ou docs/RNF.md - focar os códigos RNF07..RNF12.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - Como fazer: validar se BK-MF6-02 está concluído ou suficientemente estável para suportar este BK.
   - O que verificar: existe baseline claro para iniciar BK-MF6-04.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Otimizacao de performance critica em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
3. **Objetivo (~25 min): desenhar fluxo e critérios antes de implementar**
   ...
   - O que verificar: fluxo alinhado com RNF07..RNF12 e sem invadir BKs adjacentes.
...
- **Smoke**
  - O objetivo Otimizacao de performance critica pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF6-05.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Otimizacao de performance critica.
  - Falhas esperadas ficam explícitas e sem comportamento ambíguo.
- **Técnico**
  - Alinhamento confirmado com RNF07..RNF12.
...
- proof: BK BK-MF6-04 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
