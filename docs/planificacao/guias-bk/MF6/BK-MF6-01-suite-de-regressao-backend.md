...
Neste BK vamos entregar Suite de regressão backend, com foco num fluxo claro e executável para alunos em contexto de PAP.
...
- Entregar o objetivo central: Suite de regressão backend.
...
- docs/planificacao/backlogs/BACKLOG-MVP.md - localizar a linha do BK-MF6-01, owner, esforço e dependências.
...
1. **Objetivo (~10 min): confirmar ponto de partida**
   ...
   - O que verificar: existe baseline claro para iniciar BK-MF6-01.
...
2. **Objetivo (~15 min): traduzir o requisito em tarefas pequenas**
   ...
   - Como fazer: decompor Suite de regressão backend em 3 a 5 tarefas objetivas (entrada, processamento, saída, validação, evidência).
...
- **Smoke**
  - O objetivo Suite de regressão backend pode ser demonstrado de ponta a ponta no contexto atual.
  - Não há bloqueio imediato para o BK-MF6-02.
- **Negativos**
  - Existe pelo menos 1 teste de erro/validação diretamente ligado a Suite de regressão backend.
...
- proof: BK BK-MF6-01 documentado com guia pedagógico completo, alinhado com backlog e requisitos associados.
