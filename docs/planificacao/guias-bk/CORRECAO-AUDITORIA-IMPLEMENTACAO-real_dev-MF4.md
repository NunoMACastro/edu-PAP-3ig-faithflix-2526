...
- `proof_scope`: correção MF4 observada em 2026-06-15; atomicidade posterior não é provada por este snapshot

> **Snapshot histórico de 2026-06-15:** este relatório conserva a correção
> executada nessa data. Não constitui prova atual de seeds/E2E nem descreve a
> atomicidade administrativa acrescentada em 2026-07-10. Para o estado atual de
> candidaturas, review e memberships, consultar o adendo no relatório
> `AUDITORIA-IMPLEMENTACAO-real_dev-MF4.md` e o report end-to-end canónico.
