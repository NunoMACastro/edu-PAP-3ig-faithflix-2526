/**
 * @file Ficheiro `real_dev/backend/src/modules/subscriptions/subscriptions.service.js` da implementação real_dev.
 */
 ...
 * pertença vindo do frontend. Também centraliza datas de ciclo para que
...
/**
 * Converte uma subscrição em dados seguro para UI/API.
 *
...
export async function activateSubscription(userId, planCode) {
  ...
  // A notificação de subscrição ativa fica centralizada para evitar duplicação no pagamento aprovado.
