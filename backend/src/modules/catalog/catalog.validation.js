...
export function parseCatalogPagination(input = {}) {
    ...
    // Offsets negativos ou zero poderiam gerar queries ambiguas e degradar a medicao de performance.
    if (!Number.isInteger(page) || page < 1) {
        throw new HttpError(400, "Pagina invalida.");
    }

    // O teto protege RNF09: a rota publica nunca deve descarregar o catalogo inteiro num so pedido.
