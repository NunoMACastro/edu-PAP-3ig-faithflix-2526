...
test("MF5 valida eliminacao, consentimentos, admin users, metricas e integracoes", () => {
    ...
    assert.equal(assertMetricsRange({}).from instanceof Date, true);
    assert.throws(
...
test("MF5 metricas admin somam o pool solidario pelo campo totalPoolCents", async () => {
